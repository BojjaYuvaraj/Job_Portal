...
const Applications = () => {
  ...
  const { backendUrl, userData,  fetchUserData, fetchUserApplications } = useContext(AppContext);
          ...
          {isEdit || (userData && userData.resume === "") ? (
            ...
            <div className='flex gap-2'>
              {userData && userData.resume && (
                <a target='_blank' href={userData.resume} className='bg-blue-100 text-blue-600 px-4 rounded-lg'>
                  Resume
                </a>
              )}
